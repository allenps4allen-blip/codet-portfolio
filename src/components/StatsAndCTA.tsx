...
function StatsBar() {
  const stats = [
    ...
    { value: 2, suffix: "M+", label: "API Calls Handled" },
        ...
        {stats.map((stat, i) => (
          <div key={i} style={s.statItem}>
            <div style={s.statValue}>
              <AnimatedCounter end={stat.value} suffix={stat.suffix} duration={1600 + i * 200} />
            </div>
  ...
  return (
    <div ref={ref} className="cta-section" style={s.ctaSection}>
      ...
      <div style={{
        ...
        <span style={s.ctaEyebrow}>Ready?</span>
        <h2 className="cta-h2" style={s.ctaH2}>
          Let&apos;s build something<br />
          <span style={{ color: "#00a884" }}>your competitors can&apos;t ignore</span>
        </h2>
        <p style={s.ctaDesc}>
          Free consultation. No commitments. Just a conversation about what&apos;s possible.
        </p>
        ...
        <div style={s.trustRow}>
          <span style={s.trustItem}>✓ Free consultation</span>
          <span style={s.trustDot}>·</span>
          <span style={s.trustItem}>✓ 48hr response</span>
          <span style={s.trustDot}>·</span>
          <span style={s.trustItem}>✓ Based in Kuwait</span>
        </div>
      </div>
    </div>
  );
